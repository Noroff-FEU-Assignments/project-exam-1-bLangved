...
1. Decide on the theme for the blog you’re going to make (CHECK)
2. Create a prototype of the website (CHECK)
3. Install WordPress on your web host and add the blogs on the admin panel. (CHECK)
